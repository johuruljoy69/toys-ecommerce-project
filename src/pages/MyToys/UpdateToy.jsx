...
const UpdateToy = () => {
    ...
    return (
        <div className='mt-20 mx-20'>
            <h2 className='text-center text-3xl font-bold pb-10 text-transparent bg-clip-text bg-gradient-to-r from-purple-700 to-pink-600'>Update A Toy Product Information</h2>
